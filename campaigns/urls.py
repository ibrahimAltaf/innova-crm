...
urlpatterns = [
    ...
    path("sender-pool/", views.sender_pool, name="sender_pool"),
    ...
    path("campaigns/<int:pk>/recipients/remove/", views.campaign_recipients_remove, name="recipients_remove"),
    ...
    path("contacts/bulk-delete/", views.contacts_bulk_delete, name="contacts_bulk_delete"),
